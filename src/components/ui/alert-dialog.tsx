...
interface ConfirmationAlertDialogProps extends ConfirmOptions {
  open: boolean;
  ...
  cancelProps?: React.ComponentProps<typeof AlertDialogPrimitive.Cancel>;
  actionProps?: React.ComponentProps<typeof AlertDialogPrimitive.Action>;
}
...
function ConfirmationAlertDialog({
  ...
  return (
    <AlertDialog {...dialogProps} open={open} onOpenChange={onOpenChange}>
      <AlertDialogContent {...contentProps}>
        ...
        <AlertDialogFooter {...footerProps}>
          {buttonOrder?.map((button) => {
            if (button === "cancel" && !hideCancelButton) {
              return (
                <AlertDialogCancel
                  key="cancel"
                  onClick={onCancel}
