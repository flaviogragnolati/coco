...
Load this reference when published survey/interview evidence, competitor intelligence, concentration, sensitive evidence, or advisory boundaries matter.

This skill performs secondary analysis only. It does not contact, recruit, survey, interview, compensate, or manage consent for participants; collect or store PII or recordings; operate campaigns; process raw response-level survey data; or make sample-based inferential claims from primary microdata. Return those requests as capability gaps. Published aggregate survey or interview results may be used only through registered Findings with producer, population, sample, method, field period, limitations, revision status, and lawful-use context.
