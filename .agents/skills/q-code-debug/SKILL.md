...
6. Apply the smallest correction that resolves the verified cause. Comment only what the code cannot say, to the `q-review-comments` rubric; leave no narration of the fix, hypothesis trail, or ticket reference in the source.
